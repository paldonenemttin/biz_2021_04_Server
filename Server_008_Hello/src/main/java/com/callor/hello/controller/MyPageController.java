...
import com.callor.hello.controller.model.MemberVO;
...
public class MyPageController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		MemberVO memberVO = new MemberVO(username,password,name,tel,addr);
		
		
		
		out.println("<p>===========================");
		out.println("<p>회원정보 수정완료");
		out.println("<p>===========================");
